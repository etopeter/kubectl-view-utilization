...
@test "[no3] cluster-medium (mawk)> kubectl view utilization nodes " {
    ...
    [[ "${lines[3]}" == "ip-10-1-1-11.us-west-2.compute.internal      4214        448       0        0  2220883968         80       0        0" ]]
    [[ "${lines[4]}" == "ip-10-1-1-12.us-west-2.compute.internal         0          0       0        0           0          0       0        0" ]]
    [[ "${lines[5]}" == "ip-10-1-1-14.us-west-2.compute.internal      3013         37       0        0  2214592512          6       0        0" ]]
    [[ "${lines[6]}" == "ip-10-1-1-15.us-west-2.compute.internal      8508        106       0        0  5637144576         17       0        0" ]]
    [[ "${lines[7]}" == "ip-10-1-1-16.us-west-2.compute.internal      5015         62       0        0  3221225472          9       0        0" ]]
}
...
@test "[no4] cluster-big (mawk)> kubectl view utilization nodes " {
    ...
    [[ "${lines[4]}" == "ip-10-1-1-14.us-west-2.compute.internal      2102         52       0        0  1147142144          7       0        0" ]]
